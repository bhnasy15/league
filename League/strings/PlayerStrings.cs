namespace League
{
    ...
    {
        private PlayerStrings(List<string> value) { Value = value; }

        public List<string> Value { get; set; }

        public static PlayerStrings Names
        {
            get
            {
                return new PlayerStrings(new List<string>
                {
        ...
        public static PlayerStrings Countries
        {
            get
            {
                return new PlayerStrings(new List<string>
        ...
        public static PlayerStrings ProfielImages
        {
            get
            {
                return new PlayerStrings(new List<string>
